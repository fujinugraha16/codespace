if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition((position) => {
        ...
        function addDraggableMarker(map, behavior) {
            ...
            // re-enable the default draggablity of the underlying map
        ...
        let spaces = [];
        const fecthSpaces = function (latitude, longitude, radius) {
        ...
        function init(latitude, longitude, radius) {
            clearSpace();
            fecthSpaces(latitude, longitude, radius).then(function () {
        ...
        function addSummaryToPanel(summary) {
            ...
            const markup = `
                <ul>
                    ...
                    <li>Travel Time: ${summary.travelTime.toMMS()} (in current traffic)</li>
                </ul>
            `;
